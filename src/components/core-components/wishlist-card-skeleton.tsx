...
export default function WishlistCardSkeleton({ className }: WishlistCardSkeletonProps) {
  return (
    <div
      className={cn(
        'group relative flex flex-col bg-card border border-border rounded-lg overflow-hidden shadow-sm md:h-[380px]',
        className
      )}
    >
