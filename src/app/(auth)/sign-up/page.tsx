            ...
            <div className="space-y-6 lg:space-y-8">
              ...
              >
                ...
                <button
                  ...
                  className="w-full cursor-pointer h-12 rounded-xl border-2 border-gray-300 hover:border-gray-400 bg-white hover:bg-gray-50 text-gray-700 font-medium transition-all duration-300 hover:shadow-md transform hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2"
                >
